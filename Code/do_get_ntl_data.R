...
if (!file.exists(bm_panel_path("pr_gapfilled_2019"))) {
  ntl_panel_pr_2019 <- build_bm_tract_panel(
    tracts_sf = county_polygons_pr,
    dates = date_seq_2019,
    bearer = input_nasa_bearer,
    ntl_variable = ntl_variable,
...
if (!file.exists(bm_panel_path("pr_gapfilled_2024"))) {
  ntl_panel_pr_2024 <- build_bm_tract_panel(
    tracts_sf = county_polygons_pr,
    dates = date_seq_2024,
    bearer = input_nasa_bearer,
    ntl_variable = ntl_variable,
...
if (!file.exists(bm_panel_path("fl_gapfilled_2019"))) {
  ntl_panel_fl_2019 <- build_bm_tract_panel(
    tracts_sf = county_polygons_fl,
    dates = date_seq_2019,
    bearer = input_nasa_bearer,
    ntl_variable = ntl_variable,
...
if (!file.exists(bm_panel_path("tx_gapfilled_2019"))) {
  ntl_panel_tx_2019 <- build_bm_tract_panel(
    tracts_sf = county_polygons_tx,
    dates = date_seq_2019,
    bearer = input_nasa_bearer,
    ntl_variable = ntl_variable,
...
if (!file.exists(bm_panel_path("nc_gapfilled_2024"))) {
  ntl_panel_nc_2024 <- build_bm_tract_panel(
    tracts_sf = county_polygons_nc,
    dates = date_seq_2024,
    bearer = input_nasa_bearer,
    ntl_variable = ntl_variable,
...
if (!file.exists(bm_panel_path("la_gapfilled_2019"))) {
  ntl_panel_la_2019 <- build_bm_tract_panel(
    tracts_sf = county_polygons_la,
    dates = date_seq_2019,
    bearer = input_nasa_bearer,
    ntl_variable = ntl_variable,
